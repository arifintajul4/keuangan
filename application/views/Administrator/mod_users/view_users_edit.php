    ...
    <div class="card">
      ...
      <div class="body">
        ...
        <?php 
          ...
          echo form_open_multipart($this->uri->segment(1).'/edit_manajemenuser/'.$siswa->nis,$attributes);  ?>
          <div class='row-md-12'>
              <div class="row-md-12">
                ...
                <div class="row row-md-12">
                  ...
                  <div class="col col-md-9">
                    <select name="kewarganegaraan" class='form-control'>
                      ...
                      <option <?= ($siswa->kewarganegaraan == 'WNA') ? 'selected' : '' ?> value='WNA'>WNI</option>
                      <option <?= ($siswa->kewarganegaraan == 'WNI') ? 'selected' : '' ?> value='WNI'>WNA</option>
                    </select>
                  </div>
                </div>
                <div class="row row-md-12">
                  ...
                  <div class="col-md-9">
                    <textarea class="form-control" rows="3" name="alamat_siswa"><?= $siswa->alamat ?></textarea>
                  </div>
                </div>
                <div class="row row-md-12">
